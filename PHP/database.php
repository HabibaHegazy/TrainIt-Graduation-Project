...
class database {
	...
	public $username = "id12751880_trainit";
	public $password = "@PKKDh4RtBmE7wG";
	public $db = "id12751880_trainit_database";
    public static $con;
    public $dbConnection;
	...
	public static function rand_number( $table ) {
    	...
    	$sql = "SELECT FLOOR(RAND() * (SELECT COUNT(*) FROM $table)*100000) AS rand_number FROM $table WHERE 'rand_number' NOT IN (SELECT rand_number FROM $table) LIMIT 1";
    ...
    public static function error_msg(){
        $error = "Error description: " . mysqli_error(self::$con);
        return $error;
    }
